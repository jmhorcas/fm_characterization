...
class FMProperties(Enum):
    ...
    LEAF_FEATURES = FMProperty('Leaf features', "Features that have not subfeatures (aka 'primitive features').", FEATURES)
    ...
    ALTERNATIVE_GROUPS = FMProperty('Alternative groups', '', FEATURE_GROUPS)
    OR_GROUPS = FMProperty('Or groups', '', FEATURE_GROUPS)
    MUTEX_GROUPS = FMProperty('Mutex groups', '', FEATURE_GROUPS)
    CARDINALITY_GROUPS = FMProperty('Cardinality groups', '', FEATURE_GROUPS)
